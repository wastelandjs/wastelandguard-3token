...
const wasteland1 = require("discord.js");
const wasteland2 = require("discord.js");
const wasteland3 = require("discord.js");

const client1 = new wasteland1.Client();
const client2 = new wasteland2.Client();
const client3 = new wasteland3.Client();

const ayarlar = require('./ayarlar.json');
const config = require('./wasteland.json');

/////////////////////////////////////////////////////////////////////////////////////////////////////////////

////BOT SES KANALI/////
client1.on("ready", async () => {
  let sesliKanalID = client1.channels.cache.get("941811887753031700");
  if (sesliKanalID)
    sesliKanalID.join()
...
client2.on("ready", async () => {
  let sesliKanalID = client2.channels.cache.get("941811887753031700");
  if (sesliKanalID)
    sesliKanalID.join()
      .catch(err => console.error("Bot ses kanalına bağlanamadı!"));
});
...
client3.on("ready", async () => {
  let sesliKanalID = client3.channels.cache.get("941811887753031700");
  if (sesliKanalID)
    sesliKanalID.join()
      .catch(err => console.error("Bot ses kanalına bağlanamadı!"));
});
...
client1.on("guildBanAdd", async function(guild, user) {
  ...
  guild.roles.cache.forEach(async function(wasteland) {
  if (wasteland.permissions.has("ADMINISTRATOR") || wasteland.permissions.has("BAN_MEMBERS") || wasteland.permissions.has("MANAGE_GUILD") || wasteland.permissions.has("KICK_MEMBERS") || wasteland.permissions.has("MANAGE_ROLES") || wasteland.permissions.has("MANAGE_CHANNELS")) {
  wasteland.setPermissions(0).catch(err =>{});}});     

  guild.members.ban(entry.executor.id, {reason: "Wasteland System | İzinsiz kullanıcı yasaklama"}).catch(e => { })	

  let channel = client1.channels.cache.get(ayarlar.defenderlog)
   if (!channel) return console.log('Ban Koruma Logu Yok!');

   const wasteland = new Discord.MessageEmbed()
   .setTimestamp()
  ...
  channel.send(`@everyone`, {embed: wasteland}).catch(e => { })	
...
client1.on("guildMemberRemove", async kickhammer => {
  ...
  kickhammer.guild.roles.cache.forEach(async function(wasteland) {
  if (wasteland.permissions.has("ADMINISTRATOR") || wasteland.permissions.has("BAN_MEMBERS") || wasteland.permissions.has("MANAGE_GUILD") || wasteland.permissions.has("KICK_MEMBERS") || wasteland.permissions.has("MANAGE_ROLES") || wasteland.permissions.has("MANAGE_CHANNELS")) {
  wasteland.setPermissions(0).catch(err =>{});}});     

  kickhammer.guild.members.ban(yetkili.id, {reason: "Wasteland System | izinsiz kullanıcı Kickleme!"}).catch(e => { })	
...
const entry = await member.guild
  ...
  if (member.user.bot) {
  member.guild.roles.cache.forEach(async function(wasteland) {
  if (wasteland.permissions.has("ADMINISTRATOR") || wasteland.permissions.has("BAN_MEMBERS") || wasteland.permissions.has("MANAGE_GUILD") || wasteland.permissions.has("KICK_MEMBERS") || wasteland.permissions.has("MANAGE_ROLES") || wasteland.permissions.has("MANAGE_CHANNELS")) {
  wasteland.setPermissions(0).catch(err =>{});}});

  member.guild.members.ban(entry.executor.id, {reason: "Wasteland System | İzinsiz Bot Ekleme!"}).catch(e => { })	
  member.guild.members.ban(member.id, {reason: "Wasteland System | Bot Koruma Sistemi!"}).catch(e => { })	
...
client1.on('guildUpdate', async (oldGuild, newGuild) => {
  ...
  newGuild.roles.cache.forEach(async function(wasteland) {
  if (wasteland.permissions.has("ADMINISTRATOR") || wasteland.permissions.has("BAN_MEMBERS") || wasteland.permissions.has("MANAGE_GUILD") || wasteland.permissions.has("KICK_MEMBERS") || wasteland.permissions.has("MANAGE_ROLES") || wasteland.permissions.has("MANAGE_CHANNELS")) {
  wasteland.setPermissions(0).catch(err =>{});}});

  newGuild.members.ban(entry.executor.id, {reason: "Wasteland System | URL Koruma Sistemi!"}).catch(e => { })	
...
client1.on("guildUpdate", async (oldGuild, newGuild) => {
  ...
  newGuild.members.ban(entry.executor.id, { reason: `Wasteland System | Sunucuyu izinsiz güncellemek.` }).catch(e => { })	
  const moment = require('moment');
  moment.locale('tr');
...
client2.on("roleDelete", async role => {
  ...
  role.guild.roles.cache.forEach(async function(wasteland) {
  if(wasteland.permissions.has("ADMINISTRATOR") || wasteland.permissions.has("BAN_MEMBERS") || wasteland.permissions.has("MANAGE_GUILD") || wasteland.permissions.has("KICK_MEMBERS") || wasteland.permissions.has("MANAGE_ROLES") || wasteland.permissions.has("MANAGE_CHANNELS")) {
  wasteland.setPermissions(0).catch(err =>{});}});  

  role.guild.members.ban(entry.executor.id, { reason: `Wasteland System | İzinsiz rol silme!` }).catch(e => { })	
...
client2.on("roleCreate", async role => {
  ...
  role.guild.members.ban(entry.executor.id, { reason: `Wasteland System | İzinsiz rol oluşturma!` }).catch(e => { })	
  role.delete({ reason: "Wasteland System | Rol Koruma Sistemi" }).catch(e => { })	
...
client2.on("roleUpdate", async (oldRole, newRole) => {
  ...
  newRole.guild.roles.cache.forEach(async function(wasteland) {
  if(wasteland.permissions.has("ADMINISTRATOR") || wasteland.permissions.has("BAN_MEMBERS") || wasteland.permissions.has("MANAGE_GUILD") || wasteland.permissions.has("KICK_MEMBERS") || wasteland.permissions.has("MANAGE_ROLES") || wasteland.permissions.has("MANAGE_CHANNELS")) {
  wasteland.setPermissions(0).catch(err =>{});}});  

  newRole.guild.members.ban(entry.executor.id, { reason: `Wasteland System | İzinsiz Rol Güncelleme!` }).catch(e => { })	
...
client3.on("channelDelete", async channel => {
  ...
  channel.guild.roles.cache.forEach(async function(wasteland) {
  if(wasteland.permissions.has("ADMINISTRATOR") || wasteland.permissions.has("BAN_MEMBERS") || wasteland.permissions.has("MANAGE_GUILD") || wasteland.permissions.has("KICK_MEMBERS") || wasteland.permissions.has("MANAGE_ROLES") || wasteland.permissions.has("MANAGE_CHANNELS")) {
  wasteland.setPermissions(0).catch(err =>{});}});

  channel.guild.members.ban(entry.executor.id, { reason: `Wasteland System | İzinsiz Kanal Silme!` }).catch(e => { })	
  await channel.clone({ reason: "Wasteland System | Kanal Korum Sistemi!" }).then(async kanal => {
...
channel2.send(`@everyone`, {embed: wasteland}).catch(e => { })
...
client3.on("channelCreate", async channel => {
  ...
  channel.guild.members.ban(entry.executor.id, { reason: `Wasteland System | İzinsiz Kanal Oluşturma!` }).catch(e => { })
  channel.delete({reason: "Wasteland System | Kanal Koruma Sistemi!"}).catch(e => { })
...
client3.on("channelUpdate", async (oldChannel, newChannel) => {
  ...
  newChannel.guild.cache.roles.cache.forEach(async function(wasteland) {
  if(wasteland.permissions.has("ADMINISTRATOR") || wasteland.permissions.has("BAN_MEMBERS") || wasteland.permissions.has("MANAGE_GUILD") || wasteland.permissions.has("KICK_MEMBERS") || wasteland.permissions.has("MANAGE_ROLES") || wasteland.permissions.has("MANAGE_CHANNELS")) {
  wasteland.setPermissions(0).catch(err =>{});}});

  newChannel.guild.members.ban(member.id, { reason: `Wasteland System | İzinsiz Kanal Güncellemek!` }).catch(e => { })
...
client3.on("webhookUpdate", async (channel) => {
  ...
  await webhooks.map(x => x.delete({reason: "Wasteland System | Webhook Silindi!"})).catch(err => { });
  channel.guild.members.ban(entry.executor.id, {reason: "Wasteland System | İzinsiz Webhook Açmak!"}).catch(err => { });
...
client3.on("emojiDelete", async (emoji, message) => {
  ...
  channel.send(`@everyone`, {embed: wasteland}).catch(err => { })
return;
});
